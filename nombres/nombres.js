...
function coder() {
    ...
    document.getElementById("result").innerHTML = "<p class=\"texte-blanc\">" + message + "</p>" + '<img id="copy" src="copy.png" alt="copy icon" style="width:25px;height:25px;" onclick="copyResultOnClipboard()" >';
}
