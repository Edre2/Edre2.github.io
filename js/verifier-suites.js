...
function restituer_suites()
{
  ...
  document.getElementById("suites").innerHTML += '<div class="milieu espace-haut-bas"><input id="suite-memoire-0" type="text" class="espace-caracters fill" autofocus></label></div>';
